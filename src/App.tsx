...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--background)] text-[var(--foreground)] transition-all duration-700 font-sans selection:bg-emerald-600/20 relative bg-dots">
